...
2. `cmake_command.txt` dosyasındaki komutları kullanarak yapılandırmayı başlatın:
    ```bash
...
2. Start the configuration process using the commands in the `cmake_command.txt` file:
    ```bash
    # Add commands here
    ```
